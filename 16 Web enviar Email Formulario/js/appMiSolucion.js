...
function validarFormulario(e) {
    ...
    if (itemsForm.email === true && itemsForm.asunto === true && itemsForm.mensaje === true) {
...
function mostrarError(mensaje) {
    ...
    mensajeError.classList.add('error', 'border-2', 'border-red-700', 'bg-red-600', 'text-white', 'text-center', 'p-3', 'font-bold', 'mt-5');
